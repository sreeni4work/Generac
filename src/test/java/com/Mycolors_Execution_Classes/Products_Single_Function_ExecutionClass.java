...
import com.PowerPlay.CommonPages.MyColorPages;
import com.PowerPlay.Pages.PT_MyColors_ImportColors;
import com.PowerPlay.Pages.PT_PowerPlay_Login;
import com.PowerPlay.Pages.PT_MyColors_Products;
import com.PowerPlay.Pages.Page_Login;
import com.PowerPlay.PagesData.Member_SignUpPagedata;
...
public class Products_Single_Function_ExecutionClass {
	...
	public static void addProduct_Execution() throws BiffException, IOException, InterruptedException {
		CurrentPageTestCaseName = "Adding new Products";
	...
	public static void editProduct_Execution() throws BiffException, IOException, InterruptedException {
		CurrentPageTestCaseName = "Edit Existing Product";
		ReportingPages.AttachTestcaseReport(CurrentPageTestCaseName);
		MyColorPages.PT_MyColors_ClickProducts();
		...
		int TotalRowsInSheet = EditProductData.GetRows();
	...
	public static void Beforetest() throws IOException, BiffException {
		...
		ProductExcelSheetPath = System.getProperty("user.dir") + "/Resources/TestData/UAT/Products_UAT_TestData.xls";
		ImportColorExcelSheetPath = System.getProperty("user.dir") + "/Resources/TestData/ImportColors_Testdata.xls";
		//ReportingPages = new BasePages(HTMLReportPAth, CurrentPageTestCaseName);
		ReportingPages = new BasePages(HTMLReportPAth);	
		ProductWritePath = System.getProperty("user.dir") + "/Resources/TestOutData/UAT/Products_UAT_TestResults.xls";
		ImprtColorWritePath = System.getProperty("user.dir") + "/Resources/TestOutData/ImportColors_Testdata.xls";		
	...
	public static void MyColorsProcess() throws Exception {
		...
		Thread.sleep(4000);		
		//addProduct_Execution();
		//editProduct_Execution();		
		deleteProduct_Execution();			
	}
