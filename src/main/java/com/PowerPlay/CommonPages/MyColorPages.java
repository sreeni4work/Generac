package com.PowerPlay.CommonPages;

import java.awt.AWTException;
import java.io.IOException;
import java.text.ParseException;

import com.PowerPlay.Pages.PT_MyColors_MainMenu;
...
public class MyColorPages {
	...
	public static void PT_MyColors_ImportColors(int row) throws Exception {
		com.PowerPlay.Pages.PT_MyColors_ImportColors getPage_Page_importColors = new com.PowerPlay.Pages.PT_MyColors_ImportColors();
	...
	public static void PT_MyColors_addColorLibraries(int row) throws Exception {
		com.PowerPlay.Pages.PT_MyColors_ColorLibraries getPage_Page_addColorLibrary = new com.PowerPlay.Pages.PT_MyColors_ColorLibraries();		
	...
	public static void PT_MyColors_editColorLibraries(int row) throws Exception {
		com.PowerPlay.Pages.PT_MyColors_ColorLibraries getPage_Page_editColorLibrary  = new com.PowerPlay.Pages.PT_MyColors_ColorLibraries();
	...
	//Delete existing ColorLibrary
		public static void PT_MyColors_deleteColorLibraries(int row) throws Exception {
			com.PowerPlay.Pages.PT_MyColors_ColorLibraries getPage_Page_deleteColorLibrary = new com.PowerPlay.Pages.PT_MyColors_ColorLibraries();
